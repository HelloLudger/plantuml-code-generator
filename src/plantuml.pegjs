...
newline
  ...
  / [\n]
classdeclaration
  = noise "class " noise classname:objectname noise color? noise classtype:objecttype? noise startblock lines:umllines endblock       { var Class = require("./Class"); return new Class(classname, lines, classtype) }
  / noise "class " noise classname:objectname noise color? noise classtype:objecttype? noise                                          { var Class = require("./Class"); return new Class(classname, null, classtype) }
  / noise "class " noise classname:objectname noise color? noise classtype:objecttype? noise newline noise lines:umllines "end class" { var Class = require("./Class"); return new Class(classname, lines, classtype) }
...
rdf_name
  = item:([a-zA-Z0-9:_-]+) { return item.join("") }